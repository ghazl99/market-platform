...
<head>
    ...
    <style id="critical-theme-styles">
        ...
        /* Traditional Store Badge */
        .dashboard-type-traditional {
        ...
        html[data-theme="dark"] .dashboard-type-digital {
            background: linear-gradient(135deg, #059669 0%, #047857 100%);
            box-shadow: 0 2px 8px rgba(16, 185, 129, 0.4);
        }

        html[data-theme="dark"] .dashboard-type-traditional {
...
<body class="loaded">
    <div class="dashboard-container">
        @include('core::dashboard.digital.layouts.sidebar')
        <!-- Main Content -->
        <main class="dashboard-main" id="mainContent">
            @include('core::dashboard.digital.layouts.nav')
            @yield('content')
        </main>
    </div>
    @stack('scripts')
    ...
    <script src="{{ asset('assets/js/notifications.js') }}?v={{ time() }}" onload="handleNotificationsLoaded()">
    </script>
