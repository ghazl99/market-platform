...
<header class="dashboard-topbar">
    <div class="topbar-left">
        ...
        <div class="dashboard-type-badge dashboard-type-{{ current_store()->type }}">
            <i class="fas {{ current_store()->type === 'digital' ? 'fa-laptop' : 'fa-store' }}"></i>
            <span>{{ current_store()->type === 'digital' ? __('Digital Store') : __('Traditional Store') }}</span>
        </div>
    </div>
    ...
    <div class="topbar-right">
        ...
        <a href="{{ route('dashboard.notifications') }}" class="notifications"
            title="{{ __('الإشعارات') }}">
