    ...
    <div class="container">
        ...
        {{-- <div class="sidebar">
            ...
            <div class="card sidebar-card">
                ...
                <div class="card-body" style="display:flex; flex-direction:column; gap:10px;">
                    @if ($store->status == 'active')
                        <a href="#" class="btn btn-outline-primary btn-sm"><i class="fas fa-plus"></i>
                            {{ __('Add Product') }}</a>
                        <a href="#" class="btn btn-outline-success btn-sm"><i class="fas fa-shopping-cart"></i>
                            {{ __('Manage Orders') }}</a>
                        <a href="#" class="btn btn-outline-info btn-sm"><i class="fas fa-chart-line"></i>
                            {{ __('Reports') }}</a>
                    @else
                        <button class="btn btn-outline-secondary btn-sm" disabled><i class="fas fa-lock"></i>
                            {{ __('Not available until activation') }}</button>
                    @endif
                </div>
            </div>
            ...
            <div class="card sidebar-card">
                ...
                <div class="card-body" style="display:flex; flex-direction:column; gap:10px;">
                    <a href="{{ route('stores.edit', $store) }}" class="btn btn-outline-secondary btn-sm"><i
                            class="fas fa-edit"></i> {{ __('Edit Store') }}</a>
                    <button class="btn btn-outline-danger btn-sm" onclick="deleteStore()"><i class="fas fa-trash"></i>
                        {{ __('Delete Store') }}</button>
                </div>
            </div>
