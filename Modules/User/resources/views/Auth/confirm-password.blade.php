...
@section('title', 'تأكيد كلمة المرور - منصة المتاجر')

@section('content')
<!-- Innovative Confirm Password Design -->
<div class="innovative-confirm-container">
    <!-- Animated Background -->
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="brand-section">
                        ...
                        <div class="login-brand-text">
                            <h1 class="main-title">تأكيد كلمة المرور</h1>
                            <p class="brand-description">تأكد من هويتك قبل المتابعة</p>
                    ...
                    <div class="confirm-form-container">
                        <div class="form-card">
                            <div class="card-header">
                                <h2 class="welcome-title">تأكيد كلمة المرور</h2>
                                <p class="welcome-subtitle">هذا إجراء آمن. يرجى تأكيد كلمة المرور قبل المتابعة.</p>
                            </div>

                            <form method="POST" action="{{ route('password.confirm') }}" class="innovative-form">
                                @csrf
                            ...
                            <div class="security-notice">
                                ...
                                <div class="notice-content">
                                    <h6>لماذا نحتاج تأكيد كلمة المرور؟</h6>
                                    <p>نطلب تأكيد كلمة المرور لضمان أمان حسابك عند إجراء عمليات حساسة.</p>
                                </div>
                            </div>
                            ...
                            <div class="alternative-actions">
                                ...
                                <div class="action-buttons">
                                    <button class="action-btn cancel-action">
                                        <div class="btn-icon">
                                            <i class="fas fa-times"></i>
                                        </div>
                                        <div class="btn-content">
                                            <span class="btn-title">إلغاء العملية</span>
                                            <span class="btn-subtitle">العودة للصفحة السابقة</span>
                                        </div>
                                    </button>
                                </div>
                            </div>
