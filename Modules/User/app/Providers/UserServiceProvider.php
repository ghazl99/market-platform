...
class UserServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(\Modules\User\Repositories\Auth\RegisterUserRepository::class, \Modules\User\Repositories\Auth\RegisterUserRepositoryModel::class);
        $this->app->bind(\Modules\User\Repositories\Auth\LoginUserRepository::class, \Modules\User\Repositories\Auth\LoginUserRepositoryModel::class);
