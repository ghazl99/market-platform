...
class GroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user::dashboard.'. current_store()->type .'.groups.index', compact('groups'));
    }
    ...
    public function create()
    {
        ...
        return view('user::dashboard.'. current_store()->type .'.groups.create');
    }
    ...
    public function show(Group $group)
    {
        ...
        return view('user::dashboard.'. current_store()->type .'.groups.show', compact('group', 'users'));
    }
    ...
    public function edit(Group $group)
    {
        ...
        return view('user::dashboard.'. current_store()->type .'.groups.edit', compact('group'));
    }
