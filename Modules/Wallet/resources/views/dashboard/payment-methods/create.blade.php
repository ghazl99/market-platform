                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-input" value="{{ old('name') }}"
                            required placeholder="{{ __('Enter payment method name') }}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="recipient_name" name="recipient_name" class="form-input"
                            value="{{ old('recipient_name') }}" placeholder="{{ __('Enter recipient name') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="account_number" name="account_number" class="form-input"
                            value="{{ old('account_number') }}" placeholder="{{ __('Enter account number') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="bank_name" name="bank_name" class="form-input"
                            value="{{ old('bank_name') }}" placeholder="{{ __('Enter bank name') }}">
                        @error('bank_name')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="transfer_number" name="transfer_number" class="form-input"
                            value="{{ old('transfer_number') }}" placeholder="{{ __('Enter transfer number') }}">
