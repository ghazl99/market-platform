...
@section('content')
    <div class="payment-details-container">
        <div class="page-header">
            ...
            <p class="page-subtitle">أدخل المبلغ وارفع إشعار التحويل لإتمام العملية</p>
        </div>
        ...
        <div class="payment-info-card">
            ...
            <form action="{{ route('payment-request.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="amount-section">
                    <div class="amount-label">المبلغ المراد إضافته</div>
                        ...
                        <div class="currency-selector">
                            <select class="currency-select" id="currencySelect" name="currency">
                                @php
                                    ...
                                    $currencyEn = $currencies['en']; // ['USD','EUR']
                                    $currencyAr = $currencies['ar']; // ['دولار','يورو']
                                @endphp

                                @foreach ($currencyEn as $index => $code)
                                    <option value="{{ $code }}">{{ $currencyAr[$index] }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="exchange-rate hidden" id="exchangeRate">
                        <div class="exchange-label">المبلغ بالدولار الأمريكي</div>
                        <div class="exchange-amount" id="exchangeAmount">$0.00</div>
                        <div class="exchange-rate-text" id="exchangeRateText">سعر الصرف: 1.00</div>
                    </div>

                    <div class="final-amount-display hidden" id="convertedDiv">
                        <div class="final-amount-label">المبلغ النهائي للتحويل</div>
                        <div class="final-amount-value">
                            <span id="convertedAmount">0.00</span> <span class="final-amount-currency">$</span>
                        </div>
                        <div class="final-amount-subtitle">سيتم إضافة هذا المبلغ إلى رصيدك</div>
                    </div>
                </div>
                ...
                <div class="upload-section" id="uploadSection">
                    ...
                    <div class="upload-text">ارفع إشعار التحويل</div>
                    <div class="upload-subtext">اسحب الملف هنا أو انقر للاختيار</div>
        ...
        <div class="transfer-details">
            <h3 class="section-title"><i class="fas fa-university"></i> بيانات التحويل</h3>
            <div class="transfer-info">
                <div class="info-item">
                    <div class="info-label"><i class="fas fa-user"></i> اسم المستلم</div>
                    <div class="info-value">{{ $paymentMethod->recipient_name }}</div>
                </div>

                <div class="info-item">
                    <div class="info-label"><i class="fas fa-credit-card"></i> رقم الحساب</div>
                    <div class="info-value">{{ $paymentMethod->account_number }}</div>
                </div>

                <div class="info-item">
                    <div class="info-label"><i class="fas fa-building"></i> اسم البنك</div>
                    <div class="info-value">{{ $paymentMethod->bank_name }}</div>
                </div>

                <div class="info-item">
                    <div class="info-label"><i class="fas fa-hashtag"></i> رقم التحويل</div>
                    <div class="info-value">{{ $paymentMethod->transfer_number }}</div>
                </div>
            </div>

            <div class="important-note">
                <div class="note-title"><i class="fas fa-exclamation-triangle"></i> تعليمات مهمة</div>
