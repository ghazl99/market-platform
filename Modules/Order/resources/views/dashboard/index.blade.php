                        ...
                        <tr>
                            ...
                            <td>
                                <div class="customer-info">
                                    <div class="customer-avatar">{{ substr($order->customer_name ?? 'U', 0, 1) }}</div>
                                    <div class="customer-details">
                                        <h6>{{ $order->customer_name ?? __('Guest') }}</h6>
                                        <p>{{ $order->customer_email ?? __('No email') }}</p>
                                    </div>
                                </div>
                            </td>
                                ...
                                <div class="action-buttons">
                                    ...
                                    <form action="{{ route('dashboard.order.destroy', $order->id) }}" method="POST"
                                        ...
                                        <button type="button" class="action-btn delete delete-order-btn"
                                            ...
                                            data-customer-name="{{ $order->customer_name ?? __('Guest') }}">
