...
if (typeof NotificationSystem === 'undefined') {
    ...
    try {
        ...
        // Fallback: create a simple notification system
        notifications = {
            show: function() {},
            success: function() {},
            error: function() {},
    ...
    window.showWarning = (title, message, options) => {
        try {
            ...
            console.warn('Error showing warning notification:', e);
        }
    };
    ...
    window.showInfo = (title, message, options) => {
        try {
            ...
            console.warn('Error showing info notification:', e);
        }
    };
    ...
    document.addEventListener('DOMContentLoaded', function() {
        try {
            ...
            console.warn('Error handling Laravel session messages:', error);
        }
    });
}
