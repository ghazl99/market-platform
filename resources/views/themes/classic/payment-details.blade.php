...
<style>
    ...
    .amount-input:focus {
        ...
        box-shadow: 0 0 0 3px rgba(255, 133, 51, 0.15);
    }
    ...
    .final-amount-display {
        ...
        position: relative;
        overflow: hidden;
        box-shadow: 0 8px 25px rgba(255, 133, 51, 0.3);
    }
            ...
            <form action="{{ route('payment-request.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="amount-section">
                    ...
                    <div class="amount-input-group">
                        <input class="amount-input" type="number" id="amountInput" name="amount" placeholder="0.00" min="1" step="0.01">
                ...
                <div class="upload-section" id="uploadSection">
                    ...
                    <input type="file" name="receipt_image" class="file-input" id="fileInput" accept="image/*,.pdf" multiple>

                    <button type="button" class="upload-btn" onclick="document.getElementById('fileInput').click()">
                        <i class="fas fa-plus"></i> {{ __('Choose File') }}
                    </button>

                    <div id="previewContainer" class="preview-container" style="margin-top:10px; display:flex; gap:10px; flex-wrap:wrap;"></div>
                </div>
