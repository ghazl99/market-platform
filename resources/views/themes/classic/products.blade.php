...
@push('styles')
    <style>
        ...
        html[data-theme="light"] .product-price { color: #ff6f1e !important; }
    </style>
@endpush
...
<main class="main-content-adjust">
    <section class="products-section">
        <div class="container">
            ...
            <!-- Search Input -->
            <div class="my-3">
                <input type="text" id="categorySearchInput" class="form-control" placeholder="{{ __('Search products...') }}">
            </div>
