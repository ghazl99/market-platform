...
<style>
    ...
    .services-grid {
        ...
        gap: 1.5rem; /* المسافة بين الكاردات */
    }
                                ...
                                <div class="category-img default-store-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                                        ...
                                        <rect x="44" y="26" width="8" height="12" fill="#ced4da"
                                            stroke="#adb5bd" stroke-width="0.5" />
                                        <line x1="16" y1="26" x2="16" y2="38" stroke="#adb5bd" stroke-width="0.5" />
                                        <line x1="12" y1="32" x2="20" y2="32" stroke="#adb5bd" stroke-width="0.5" />
                                        <line x1="48" y1="26" x2="48" y2="38" stroke="#adb5bd" stroke-width="0.5" />
                                        <line x1="44" y1="32" x2="52" y2="32" stroke="#adb5bd" stroke-width="0.5" />
                                    </svg>
                                </div>
                            @endif
                        </div>
